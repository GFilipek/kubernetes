...
type CachingRecommender interface {
	...
	Get(spec *api.PodSpec) (*apimock.Recommendation, error)
}
...
func (c *cachingRecommenderImpl) Get(spec *api.PodSpec) (*apimock.Recommendation, error) {
...
func getCacheKey(spec *api.PodSpec) *string {
